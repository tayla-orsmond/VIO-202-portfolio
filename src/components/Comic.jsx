    ...
    render(){
        return (
            <div className="row mx-0 text-right">
                ...
                <div className="col-3 offset-2 overlay ms-1" style={style_}>
                    ...
                    <div className='col-4 d-flex align-items-start justify-content-center'>
                        ...
                        <a href="https://vio-motion-comic.netlify.app/" className='btn btn-secondary m-xl-1' style={{borderRadius: "1rem 1rem 1rem 0"}}>View</a>
                    </div>
                </div>
            </div>
        )
