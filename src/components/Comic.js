    ...
    render() {
        return (
            <div className="row mx-0 text-right">
                <iframe style={{border: 0, margin: "0 auto", opacity: 0.8}} width="100%" height="540" src="https://rive.app/s/iLD027-o4U2XJg7uVyII9w/embed" allowFullScreen></iframe>
                ...
                <div className='col-1 d-flex flex-wrap align-items-center justify-content-center'>
